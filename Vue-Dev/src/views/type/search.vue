<template>
  <div>
    <ul>
      <li>
        <div class="glass-bg box-show" style="width:96%; height:88px; margin:0 auto 18px; box-sizing:border-box;">
      ...
      <li>
        <div class="glass-bg box-show" style="width:96%; min-height:688px; margin:0 auto; box-sizing:border-box;">
          <p style="text-align:left; font-size:18px; color:#CCC; border-bottom:1px solid #555; line-height:32px;">
