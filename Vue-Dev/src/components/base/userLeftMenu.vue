<template>
  <div class="user-left-menu" :class="{'active': this.$store.state.showUserLeftMenu}">
    ...
    <transition name="fade" >
      <div v-if="this.$store.state.showUserLeftMenu" class="user-left-menu-content box-show" :style="slideEffect" @touchstart='touchStart' @touchmove='touchMove' @touchend='touchEnd'>
